...
Brevis provides CLI utilities that streamline on-chain operations to initialize a prover.
...
> Note that this step will also automatically stake the configured minimum amount BREV tokens to ensure the prover meets the minimum self-stake requirement.
